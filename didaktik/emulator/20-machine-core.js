  ...
  with (Q) {
    ...
    }];
    {
      cpuCore = new function (f) {
        ...
        put: function (e, t) {
          var r,
            n,
            i = v;
          e < 32768 ? e < 16384 ? (r = f, i &= 17, r?.qaopWriteStart != g1 && e < r.qaopWriteStart && (i = 0)) : (r = u, i &= 34) : e < 49152 ? (r = c, i &= 68) : (r = s, i &= 136), 0 < (n = machineBus.time - o) && P5(n), o = 99999, i && (15 & i && (G5(0), o = machineBus.time + 3), r[e &= 16383] !== t) && (r === _ && T1(machineBus.time), r[e] = t);
        },
        in: function (e) {
          J5(e);
          var t,
      ...
      initializeEmulatorCore = e => {
        ...
        machineMemoryProfile === "didaktik80" && (didaktikBank = 0), cpuCore.reset(), O5(a & A1 ? 0 : 48);
        ...
        if (Y1(e, {
          ...
          border: 7 & y,
          p7FFD: m,
          memoryProfile: machineMemoryProfile,
          didaktikBank,
          pFF: w,
          cont: !!(a & D1),
          fbus: !!(a & q5),
        ...
        var t,
          ...
          f = 16384,
          o = e.pFE;
        e.memoryProfile != g1 && (machineMemoryProfile = e.memoryProfile === "didaktik80" ? "didaktik80" : e.memoryProfile === "spectrum128" ? "spectrum128" : "spectrum48"), (o = e.didaktikBank) == (0 | o) && (didaktikBank = 1 & o), o = e.pFE;
      ...
      let f, u, c, s, v, d, r, B, _, p, machineMemoryProfile = "spectrum48", didaktikBank = 0;
      setMachineMemoryProfile = (profile, bank = 0) => {
        machineMemoryProfile = profile === "didaktik80" ? "didaktik80" : profile === "spectrum128" ? "spectrum128" : "spectrum48";
        didaktikBank = bank & 1;
        rebuildBusHandlers?.();
        return getMachineBankState();
      }, getMachineMemoryProfile = () => machineMemoryProfile, getMachineBankState = () => ({
        profile: machineMemoryProfile,
        bank: machineMemoryProfile === "didaktik80" ? didaktikBank : machineMemoryProfile === "spectrum128" ? 7 & m : null,
        upperPages: machineMemoryProfile === "didaktik80" ? (didaktikBank ? [1, 3] : [2, 0]) : machineMemoryProfile === "spectrum128" ? [7 & m] : null
      }), peekMemoryRaw = pokeMemoryRaw = (e, t) => {
        var r,
          n = (e &= 65535) < 32768 ? e < 16384 ? (r = f, 16) : (r = u, 32) : e < 49152 ? (r = c, 64) : (r = s, 128);
        return e &= 16383, t != g1 && v & n && (r?.qaopWriteStart == g1 || e >= r.qaopWriteStart) && (r[e] = t), r[e];
        ...
        B = t || p, u = d[5], c = d[2], O5(m), r = {
          ...
          out(e, t) {
            if (machineMemoryProfile === "didaktik80" && (255 & e) === 127) {
              const bank = 1 & t;
              if (bank !== didaktikBank) didaktikBank = bank, O5(m);
            }
          }
        };
      ...
      function O5(e) {
        m = e;
        if (machineMemoryProfile === "didaktik80") {
          u = _ = d[5];
          c = d[didaktikBank ? 1 : 2];
          s = d[didaktikBank ? 3 : 0];
          v = 224;
          f = B || romPages["48"];
          f?.qaopWriteStart != g1 && (v |= 16);
          return;
        }
        s = d[7 & e], v = a & D1 ? 226 | e << 3 & 8 : 224, _ = d[8 & e ? 7 : 5], f = B || (16 & e ? r : romPages["128e"]), f?.qaopWriteStart != g1 && (v |= 16);
      }
      let o;
      function G5(e) {
