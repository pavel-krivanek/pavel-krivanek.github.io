module('users.bert.SqueakJS.interpreter').requires("users.bert.SqueakJS.vm").toRun(function() {
    ...
    'sending', {
        send: function(selector, argCount, doSuper) {
         ...
         //   if (!entry.method.compiled)
         //     console.log(this.printMethod(entry.method, entry.mClass, selector));
