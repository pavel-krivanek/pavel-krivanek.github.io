// Module 1: Z80 opcode tables and instruction encoder
(!(function (e, t) {
  "undefined" != typeof module
    ? ((module.exports = t()), (Z80 = module.exports))
      ...
      var r,
        ...
        u = function (e) {
          ...
          return (
            "(IX)" == n && ((t = "0"), (r = 221), (e = "(HL)")),
            "(IX+" == n &&
              ((t = e.substr(4, e.length - 5)), (r = 221), (e = "(HL)")),
            "(IX-" == n &&
              ((t = "-" + e.substr(4, e.length - 5)), (r = 221), (e = "(HL)")),
            "(IY)" == n && ((t = "0"), (r = 253), (e = "(HL)")),
            "(IY+" == n &&
              ((t = e.substr(4, e.length - 5)), (r = 253), (e = "(HL)")),
            "(IY-" == n &&
              ((t = "-" + e.substr(4, e.length - 5)), (r = 253), (e = "(HL)")),
            "IX" == n && ((r = 221), (e = "HL")),
            "IY" == n && ((r = 253), (e = "HL")),
        ...
        if (t.params && 0 !== t.params.length) {
          if (1 == t.params.length) {
            ...
            if (((s = u(b)), (b = s[0]), (v = s[1]), (g = s[2]), h[11] > 0))
              return (
                ...
                (t.lens[1] = function (e) {
                  ...
                  if (t > 127) throw "Target is out of relative jump reach";
                  if (t < -128) throw "Target is out of relative jump reach";
            ...
            if (h[12] > 0)
              return (
                ...
                "(HL)" == b.toUpperCase() && h[13] > 0
                  ? (s[2]
                      ? ((t.bytes = 2), (t.lens[0] = s[2]), (t.lens[1] = h[13]))
                      : ((t.bytes = 1), (t.lens[0] = h[13])),
                    t)
                  : ((t.bytes = 3),
                    (t.lens[0] = h[12]),
                    (t.lens[1] = function (e) {
            ...
            (r = l(b)) >= 0 && h[8] > 0
              ...
              : (r = a(b)) >= 0 && h[6] >= 0
                ? (c = h[6]) > 0 &&
                  (e.R16[t.opcode] ? (c += r << e.R16[t.opcode]) : (c += r))
                : (r = ["BC", "DE", "HL", "AF"].indexOf(b.toUpperCase())) >=
                      0 && h[7] >= 0
                  ? (c = h[7]) > 0 &&
                    (e.R16[t.opcode] ? (c += r << e.R16[t.opcode]) : (c += r))
                  : (r = o(b)) >= 0 && h[4] > 0
                    ? (c = h[4]) > 0 &&
                      (e.R8[t.opcode] ? (c += r << e.R8[t.opcode]) : (c += r))
                    : ((c = h[5]),
                      (n = function (e) {
                        return Parser.evaluate(b, e);
                      }));
            ...
            var C = t.params[0],
              x = t.params[1];
            if ("EX" == t.opcode)
              return "DE" == C.toUpperCase() && "HL" == x.toUpperCase()
                ? ((t.lens = [235]), (t.bytes = 1), t)
                : "AF" == C.toUpperCase() && "AF'" == x.toUpperCase()
                  ? ((t.lens = [8]), (t.bytes = 1), t)
                  : "(SP)" == C.toUpperCase() && "HL" == x.toUpperCase()
                    ? ((t.lens = [227]), (t.bytes = 1), t)
                    : "(SP)" == C.toUpperCase() && "IX" == x.toUpperCase()
                      ? ((t.lens = [221, 227]), (t.bytes = 2), t)
                      : "(SP)" == C.toUpperCase() && "IY" == x.toUpperCase()
            ...
            if ("IN" == t.opcode)
              return "(C)" == x.toUpperCase() && (r = i(C)) >= 0 && h[0]
                ? ((t.lens = [237, 64 + (r << 3)]), (t.bytes = 2), t)
                : "A" == C.toUpperCase()
                  ? ((t.lens = [h[1]]),
                    (t.lens[1] = function (e) {
                      return Parser.evaluate(x, e);
                  ...
                  : null;
            if ("OUT" == t.opcode)
              return "(C)" == C.toUpperCase() && (r = i(x)) >= 0 && h[0]
                ? ((t.lens = [237, 65 + (r << 3)]), (t.bytes = 2), t)
                : "A" == x.toUpperCase()
                  ? ((t.lens = [h[1]]),
                    (t.lens[1] = function (e) {
            ...
            if ("LD" == t.opcode) {
              ...
              if (
                ((m = []),
                M >= 0 && E >= 0 && ((t.bytes = 1), (m[0] = 64 + (M << 3) + E)),
            ...
            ("A" == C.toUpperCase() &&
              ...
              "IX" == C.toUpperCase() &&
                (r = ["BC", "DE", "IX", "SP"].indexOf(x.toUpperCase())) >= 0 &&
                ((c = h[2] + (r << 4)), (g = 221)),
              "IY" == C.toUpperCase() &&
                (r = ["BC", "DE", "IY", "SP"].indexOf(x.toUpperCase())) >= 0 &&
                ((c = h[2] + (r << 4)), (g = 253)),
              "HL" == C.toUpperCase() &&
                (r = a(x)) >= 0 &&
                (c = h[2] + (r << 4)));
        ...
        return (
          ...
          null !== v &&
            ...
            (3 == d &&
              ...
              (m[2] = function (e) {
                var t = Parser.evaluate(v, e);
                if (t > 127 || t < -128) throw "Index out of range (" + t + ")";
                return t;
              }),
              (d = 4)),
            2 == d &&
  ...
  (function (e, t) {
    ...
    var e = null,
      ...
      i = function (e) {
        return e.map(function (e) {
          for (
            var t = e.line,
              r = { addr: 0, line: ";;;EMPTYLINE", numline: e.numline };
            " " == t[0];
          )
            t = t.substr(1);
          return t.length ? e : r;
      ...
      a = function (e) {
        var t = 1;
        return e.map(function (e) {
          return { line: e, numline: t++, addr: null, bytes: 0 };
        });
      },
      l = function (e) {
      ...
      p = function (t, r, n, s) {
        ...
        if (
          ...
          throw { msg: t.paramstring, s: t };
        if ((".EQU" === t.opcode && (t.opcode = "EQU"), ".ORG" === t.opcode))
          try {
            return t;
          } catch (e) {
            throw { msg: e.message, s: t };
          }
        ...
        if (!t.label && !n) {
          var C = { line: t.line, numline: t.numline, addr: null, bytes: 0 };
          if (t.remark && !t.opcode) return t;
          if (!t.params)
            throw { msg: "Unrecognized instruction " + t.opcode, s: t };
          if (!t.opcode)
            throw { msg: "Unrecognized instruction " + t.opcode, s: t };
        ...
        if (n) throw { msg: "Unrecognized instruction " + s.opcode, s: t };
        throw { msg: "Unrecognized instruction " + t.opcode, s: t };
      },
      u = function (e, n) {
        var i,
          ...
          if (((i = e[g].line), (p = i.match(/\s*(\.[^\s]+)(.*)/)))) {
            ...
            if (
              ...
              if (".INCLUDE" !== b)
                if (".ENDM" !== b)
                  if (".MACRO" !== b)
                    if (".REPT" !== b) m.push(e[g]);
                      ...
                      if (!h[0])
                        throw { msg: "No repeat count given", s: e[g] };
                      if (!(d = Parser.evaluate(h[0])))
                        throw { msg: "Bad repeat count given", s: e[g] };
                ...
                if (!h || !h[0]) throw { msg: "No file name given", s: e[g] };
                if (r[h[0].replace(/\"/g, "")])
                  throw {
                    msg:
                      "File " +
                ...
                if (!M) throw { msg: "File " + h[0] + " not found", s: e[g] };
                var E = a(M.split(/\n/));
                ((E = o(E)), (E = s(E)));
        ...
        if (c)
          throw { msg: "MACRO " + c + " has no appropriate ENDM", s: e[g] };
        return [m, f];
      },
      h = function (e, t) {
        var r = {
    ...
    return {
      ...
      pass1: function (r, n) {
        var s = "CSEG",
          o = function () {
            if ("BSSEG" === s) throw h.opcode + " is not allowed in BSSEG";
          },
          i = {},
          a = 0,
          l = {};
        n && (l = n);
        for (
          var p, u, h = null, f = 0, d = 0, m = [], g = 0, v = 0, b = r.length;
          v < b;
          v++
        )
          if (
            ...
            if ("ELSE" !== h.opcode)
              if (f) h.ifskip = !0;
                ...
                if ("IFN" !== h.opcode)
                    ...
                    if (".ENDBLOCK" !== h.opcode) {
                      ...
                      try {
                        ...
                        if (
                          ...
                          if (g) throw { message: "PHASE cannot be nested" };
                      ...
                      if ("DB" === h.opcode || "FCB" === h.opcode)
                        for (o(), h.bytes = 0, u = 0; u < h.params.length; u++)
                          try {
                            if (
                              "number" ==
                              typeof (p = Parser.evaluate(h.params[u], l))
                            ) {
                              h.bytes++;
                              continue;
                            }
                      ...
                      if ("DS" !== h.opcode && "RMB" !== h.opcode)
                            ...
                            if ("BSZ" !== h.opcode && "ZMB" !== h.opcode) {
                              ...
                              if (".INCBIN" !== h.opcode)
                                ...
                                if ((o(), !h.params[0]))
                                  throw {
                                    msg:
                                      "No file name given at line " + h.numline,
                                    s: h,
                                  };
                        ...
                        if (2 == h.params.length) {
                          ("string" ==
                            typeof (p = Parser.evaluate(h.params[1], l)) &&
                            (p = p.charCodeAt(0)),
                            (h.bytes = P),
                            (h.lens = []));
                          for (var w = 0; w < P; w++) h.lens[w] = p;
                        }
                        a += P;
                      }
                    } else {
                      for (
                        var I = l["__" + m.join("/")], R = 0;
                        R < I.length;
                        R++
                      )
                        ((l[I[R]] = l[m.join("/") + "/" + I[R]]),
                  ...
                  if (d) throw { msg: "Nested IFs are not supported", s: h };
                  try {
                    (Parser.evaluate(h.params[0], l) && (f = 1), (d = 1));
                  } catch (e) {
                    throw { msg: "IF condition canot be determined", s: h };
                  }
                }
              else {
                if (d) throw { msg: "Nested IFs are not supported", s: h };
              ...
              if (!d) throw { msg: "ELSE without IF", s: h };
              f = f ? 0 : 1;
            }
          else {
            if (!d) throw { msg: "ENDIF without IF", s: h };
            ((f = 0), (d = 0));
          }
        return [r, l];
      },
          ...
          try {
            ...
            if ("IF" === a.opcode) {
              ...
              try {
                ...
                throw { message: "IF condition mismatched" };
              }
              continue;
            }
            if ("IFN" === a.opcode) {
            ...
            try {
              for (
                var d = Parser.usage(a.params[0].toUpperCase(), i), m = 0;
                m < d.length;
                m++
              )
            ...
            try {
              for (
                var d = Parser.usage(a.params[1].toUpperCase(), i), m = 0;
                m < d.length;
                m++
              )
                (c[d[m]].usage || (c[d[m]].usage = []),
            ...
            if ("DW" === a.opcode || "FDB" === a.opcode) {
              for (r = 0, a.lens = [], s = 0; s < a.params.length; s++)
                "number" != typeof (t = Parser.evaluate(a.params[s], i)) ||
                  (n
            ...
            if (
                  ...
                  ? ((l = a.lens[1](i)),
                    n
                      ? ((a.lens[3] = Math.floor(l % 256)),
                        ...
                        (a.lens[1] = Math.floor((l >> 16) & 255)))
                      : ((a.lens[1] = Math.floor(l % 256)),
                        (a.lens[2] = Math.floor((l >> 8) % 256)),
                        (a.lens[3] = Math.floor((l >> 16) & 255))))
                  : null === a.lens[2]
                    ? "string" == typeof (l = a.lens[1](i))
                      ? n
                        ? ((a.lens[1] = 255 & l.charCodeAt(0)),
                          (a.lens[2] = 255 & l.charCodeAt(1)))
                        : ((a.lens[2] = 255 & l.charCodeAt(0)),
                          (a.lens[1] = 255 & l.charCodeAt(1)))
                      : n
              ...
              a.lens &&
                ...
                null === a.lens[3]
                  ? "string" == typeof (l = a.lens[2](i))
                    ? n
                      ? ((a.lens[2] = 255 & l.charCodeAt(0)),
                        (a.lens[3] = 255 & l.charCodeAt(1)))
                      : ((a.lens[3] = 255 & l.charCodeAt(0)),
                        (a.lens[2] = 255 & l.charCodeAt(1)))
                    : n
                      ? ((a.lens[3] = 255 & l), (a.lens[2] = l >> 8))
                      : ((a.lens[2] = 255 & l), (a.lens[3] = l >> 8))
                  : (a.lens[2] = b(l))),
              a.lens &&
                a.lens.length > 3 &&
                ...
                null === a.lens[4]
                  ? "string" == typeof (l = a.lens[3](i))
                    ? n
                      ? ((a.lens[3] = 255 & l.charCodeAt(0)),
                        (a.lens[4] = 255 & l.charCodeAt(1)))
                      : ((a.lens[4] = 255 & l.charCodeAt(0)),
                        (a.lens[3] = 255 & l.charCodeAt(1)))
                    : n
                      ? ((a.lens[4] = 255 & l), (a.lens[3] = l >> 8))
                      : ((a.lens[3] = 255 & l), (a.lens[4] = l >> 8))
                  : (a.lens[3] = b(l))),
              ...
              if ((a.lens[1] > 255 || a.lens[1] < -128) && 2 == a.lens.length)
                throw { message: "param out of bounds - " + a.lens[1] };
              a.lens[1] < 0 && (a.lens[1] = 256 + a.lens[1]);
            }
          } catch (e) {
            throw { msg: e.message, s: a, e: e };
          }
        return [o, i];
      },
      parseLine: p,
      ...
      lst: function (e, t, r, n, s) {
        ...
        for (var l = 0, p = e.length; l < p; l++) {
          if (
            ...
            for (var u = 0; u < i.lens.length; u++) o += m(i.lens[u]) + " ";
      ...
      html: function (e, t, r, n) {
        ...
        for (var a = 0, l = e.length; a < l; a++) {
          if (
            ...
            void 0 !== o.addr
              ? ((s +=
                  '<td><a name="ADDR' + g(o.addr) + '">' + g(o.addr) + "</a>"),
                o.phase
            ...
            s += "<td>";
            for (var p = 0; p < o.lens.length; p++) s += m(o.lens[p]) + " ";
            s += "</td>";
          } else s += "<td></td>";
          (o.label
            ? (s += '<td><a name="LBL' + o.label + '">' + o.label + "</a></td>")
            : (s += "<td></td>"),
          ...
          if (
            (".PRAGMA" === (r = e[p]).opcode &&
              ...
              1 == r.params.length &&
                ...
                (a = !0)),
            !(r.ifskip || (a && (t || (t = "CSEG"), r.segment != t))))
          ) {
            var h = r.addr;
            if (
              (r.phase && (h -= r.phase),
              void 0 !== h && 0 === s && (n = h),
              h != n + s &&
                (s && (i += x(n, o, l)), (n = h), (s = 0), (o = [])),
              r.lens)
            ) {
              for (var f = 0; f < r.lens.length; f++) o.push(r.lens[f]);
              s += r.lens.length;
            }
          }
      ...
      srec: function (e, t) {
        for (
          var r, n = null, s = 0, o = !1, i = [], a = "", l = 0, p = e.length;
          l < p;
          l++
        )
          if (
            (".PRAGMA" === (r = e[l]).opcode &&
              ...
              "SEGMENT" == r.params[0].toUpperCase() &&
              (o = !0),
            !(r.ifskip || (o && (t || (t = "CSEG"), r.segment != t))))
          ) {
            var u = r.addr;
            if (
              (r.phase && (u -= r.phase),
              void 0 !== u && 0 === s && (n = u),
              u != n + s && (s && (a += y(n, i)), (n = u), (s = 0), (i = [])),
              r.lens)
            ) {
              for (var h = 0; h < r.lens.length; h++) i.push(r.lens[h]);
              s += r.lens.length;
            }
          }
        i.length && (a += y(n, i));
      ...
      linemap: function (e) {
        for (var t, r = [], n = 0, s = e.length; n < s; n++)
          if ((t = e[n]).lens)
            for (var o = 0; o < t.lens.length; o++) r[t.addr + o] = n + 1;
        return r;
      },
          ...
          if (((h = n[d]), (f = ""), "EMPTYLINE" != h.remark))
            if (h.label || h.opcode || !h.remark) {
              for (
                ...
                f += " ";
              for (h.opcode && (f += h.opcode + " "); f.length < 20; ) f += " ";
              (h.params && (f += h.params + " "),
                h.remark && (f += ";" + h.remark),
                (c += f + "\n"));
            } else c += ";" + h.remark + "\n";
      ...
      buff: function (e) {
        for (
          var t, r, n = new Uint8Array(65536), s = 0, o = e.length;
          s < o;
          s++
        )
          if (((t = e[s]), (r = t.addr), t.lens))
            for (var i = 0; i < t.lens.length; i++) n[r++] = t.lens[i];
        return n;
      },
      fileGet: function (e) {
        t = e;
  ...
  Array.indexOf ||
    (Array.prototype.indexOf = function (e, t) {
      for (var r = t || 0; r < this.length; r++) if (this[r] === e) return r;
      return -1;
    }));

// Module 3: Expression parser/evaluator used by directives and operands
    ...
    return (
            ...
            if (l === I) o.push(s.number_);
              ...
              if (((s.index_ = s.index_.toUpperCase()), "<" === s.index_[0]))
                ...
                s.index_.substr(1) in e &&
                  o.push(Math.floor(e[s.index_.substr(1)] / 256));
          ...
          for (l = 0; l < a; l++) {
            ...
            if (p === I) i.push(s.number_);
              ...
              if (((s.index_ = s.index_.toUpperCase()), "<" === s.index_[0]))
                ...
                s.index_.substr(1) in e &&
                  (i.push(Math.floor(e[s.index_.substr(1)] / 256)),
                  o.push(s.index_.substr(1)));
              else if (s.index_ in e) (i.push(e[s.index_]), o.push(s.index_));
              else {
                if (!(s.index_ in this.functions))
                  throw new Error("undefined variable: " + s.index_);
      ...
      (w.prototype = {
        ...
        addfunc: function (e, t, n) {
          for (
            var s = new r(n, this.tokenindex, this.tokenprio + this.tmpprio, 0);
        ...
        isNumber: function () {
          for (
            ...
            if (
              ...
              this.pos++,
              (o = t),
              "$" === t[0] && ((o = "0x" + t.substr(1)), (n = 16)),
              ("x" !== t[1] && "X" !== t[1]) || (n = 16),
              ("h" !== t[t.length - 1] && "H" !== t[t.length - 1]) ||
                (10 != n && 2 != n) ||
                ((o = "0x" + t.substr(0, t.length - 1)), (n = 16)),
              ("b" !== t[t.length - 1] && "B" !== t[t.length - 1]) ||
                (10 == n && ((o = t.substr(0, t.length - 1)), (n = 2))),
              "%" === t[0])
            ) {
        ...
        isOperator: function () {
          ...
          else if (45 === e) ((this.tokenprio = 0), (this.tokenindex = "-"));
          else if (124 === e)
            124 === this.expression.charCodeAt(this.pos + 1)
              ? (this.pos++, (this.tokenprio = 0), (this.tokenindex = "||"))
              : ((this.tokenprio = 5), (this.tokenindex = "|"));
          else if (42 === e) ((this.tokenprio = 1), (this.tokenindex = "*"));
          else if (47 === e) ((this.tokenprio = 2), (this.tokenindex = "/"));
          else if (37 === e) ((this.tokenprio = 2), (this.tokenindex = "%"));
          else if (35 === e) ((this.tokenprio = 2), (this.tokenindex = "#"));
          else if (94 === e) ((this.tokenprio = 3), (this.tokenindex = "^"));
          else if (38 === e) ((this.tokenprio = 4), (this.tokenindex = "&"));
          else if (61 === e) ((this.tokenprio = -1), (this.tokenindex = "="));
          else if (33 === e)
  ...
  rle1Decode = function (e) {
    ...
    return (
      e.forEach(function (e) {
        if ("number" != typeof e) for (var r = 0; r < e[0]; r++) t.push(e[1]);
        else t.push(e);
      }),
      t
    );
...
// Module 4: Target/container helpers (SNA, TAP, HEX conversions, downloads)
makeSNA = function (e, t) {
    ...
    return (
      ASM.ENT && ((r[7403] = 255 & ASM.ENT), (r[7404] = (ASM.ENT >> 8) & 255)),
      r
    );
  },
...
// Utility object for reading and converting Intel HEX
hextools = {
    RAM: [],
    ...
    hex2prg: function (e, t) {
      if (t < 2064) throw "ENT must be above $810";
      hextools.RAM = [];
      ...
      ((hextools.RAM[2047] = 1),
        ...
        (hextools.RAM[2059] = 0),
        (hextools.RAM[2060] = 0));
      for (var o = 2047; o < r; o++) n += "%" + toHex2(hextools.RAM[o]);
      return n;
    },
  };
