...
ig.module('game.main').requires('impact.game', 'impact.font', 'game.menus', 'game.entities.enemy-missle', 'game.entities.enemy-mine', 'game.entities.enemy-destroyer', 'game.entities.enemy-oppressor', 'game.entities.player', 'plugins.impact-splash-loader').defines(function() {
    ...
    ZType = ig.Game.extend({
        ...
        convertKey: function(letter) {
            switch (letter) {
                   case 81: return 'p'; break;
                   case 87: return 'y'; break;
                   case 69: return 'f'; break;
                   case 82: return 'i'; break;

                   case 65: return 'a'; break;
                   case 83: return 'o'; break;
                   case 68: return 'e'; break;
                   case 70: return 'u'; break;

                   case 89: return 'q'; break;
                   case 88: return 'k'; break;
                   case 67: return 'x'; break;
                   case 86: return 'd'; break;

                   case 85: return 'g'; break;
                   case 73: return 'c'; break;
                   case 79: return 'r'; break;
                   case 80: return 'l'; break;

                   case 74: return 'h'; break;
                   case 75: return 't'; break;
                   case 76: return 'n'; break;
                   case 186: return 's'; break;

                   case 77: return 'b'; break;
                   case 188: return 'm'; break;
                   case 190: return 'w'; break;
                   case 189: return 'v'; break;

                   default:  return letter;                                                                                      mm
            }
        },
        keydown: function(event) {
            ...
            var c = event.which;
            if (!((c > 64 && c < 91) || (c > 96 && c < 123) || ((c === 188) || (c === 190) || (c === 189) || (c === 186))))  {
                return true;
            }
            event.stopPropagation();
            event.preventDefault();
            var letter = this.convertKey(event.keyCode);
            console.log(letter);
        ...
        drawUI: function() {
            ...
            this.fontScore.draw(s, 4, ig.system.height - 12, ig.Font.ALIGN.LEFT);
